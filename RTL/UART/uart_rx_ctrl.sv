...
module uart_rx_ctrl(
    ...
    assign mmio_in.valid                        = !fifo_empty;
    assign mmio_in.data                         = input_fifo[rd_ptr[INPUT_FIFO_BITS-1:0]];
    ...
    assign flush                                = (rx_state == RX_CTRL_BUSY) && (cmd == CMD_RESET);
            ...
            unique case (rx_state)
                ...
                RX_CTRL_PAYLOAD: if (rx_valid) begin
                    if (cmd == CMD_INPUT) begin         // Input
                        ...
                        base_addr[{addr_counter[1:0], 3'b000} +: 8] <= rx_data;
                ...
                RX_CTRL_BUSY: begin
                    case (cmd)
                        ...
                        CMD_WRITE:  begin
                            rom_init.write_enable   <= 1;
                            rom_init.write_addr     <= base_addr + {24'b0, data_counter};
                            rom_init.write_data     <= {
